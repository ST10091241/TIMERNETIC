...
class taskAdapter : RecyclerView.Adapter<taskAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val taskStartTextView: TextView = itemView.findViewById(R.id.taskStartTextView)
        private val taskEndTextView: TextView = itemView.findViewById(R.id.taskEndTextView)
